...
<div class="nav-wrapper teal darken-4">
    ...
    <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a href="#" onclick="onNavigate('https://altugozengi.github.io/VanillaJS-SPA-App/'); return false;">Home</a></li>
        <li><a href="#" onclick="onNavigate('https://altugozengi.github.io/VanillaJS-SPA-App/about'); return false;">About</a></li>
        <li><a href="#" onclick="onNavigate('https://altugozengi.github.io/VanillaJS-SPA-App/contact'); return false;">Contact</a></li>
    </ul>
</div>
</nav><div class="section no-pad-bot orange lighten-5" id="index-banner">
<div class="container">
    <br><br>
    <h1 class="header center  orange-text text-darken-3">Contact Page</h1>
    <div class="row center">
        <h5 class="header col s12 light">This is contact page</h5>
    </div>
    <br><br>
</div>
</div>
